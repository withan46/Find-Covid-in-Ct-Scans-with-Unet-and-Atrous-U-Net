# -*- coding: utf-8 -*-
"""Athanasios Emmanouilidis Unet Code

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1yz82QFzTXtyrfl34O1EEoYRN506a0sX5
"""
...
def unet_model(input_size=(256, 256, 1)):
    ...
    # Encoder
    c1 = Conv2D(16, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(inputs)
    c1 = BatchNormalization()(c1)
    c1 = Activation('relu')(c1)
    c1 = Dropout(0.1)(c1)
    c1 = Conv2D(16, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c1)
    c1 = BatchNormalization()(c1)
    c1 = Activation('relu')(c1)
    c1 = Dropout(0.1)(c1)
    p1 = MaxPooling2D((2, 2))(c1)

    c2 = Conv2D(32, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(p1)
    c2 = BatchNormalization()(c2)
    c2 = Activation('relu')(c2)
    c2 = Dropout(0.1)(c2)
    c2 = Conv2D(32, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c2)
    c2 = BatchNormalization()(c2)
    c2 = Activation('relu')(c2)
    c2 = Dropout(0.1)(c2)
    p2 = MaxPooling2D((2, 2))(c2)

    c3 = Conv2D(64, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(p2)
    c3 = BatchNormalization()(c3)
    c3 = Activation('relu')(c3)
    c3 = Dropout(0.1)(c3)
    c3 = Conv2D(64, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c3)
    c3 = BatchNormalization()(c3)
    c3 = Activation('relu')(c3)
    c3 = Dropout(0.1)(c3)
    p3 = MaxPooling2D((2, 2))(c3)

    c4 = Conv2D(128, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(p3)
    c4 = BatchNormalization()(c4)
    c4 = Activation('relu')(c4)
    c4 = Dropout(0.1)(c4)
    c4 = Conv2D(128, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c4)
    c4 = BatchNormalization()(c4)
    c4 = Activation('relu')(c4)
    c4 = Dropout(0.1)(c4)
    ...
    # Bottleneck
    c5 = Conv2D(256, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(p4)
    c5 = BatchNormalization()(c5)
    c5 = Activation('relu')(c5)
    c5 = Dropout(0.1)(c5)
    c5 = Conv2D(256, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c5)
    c5 = BatchNormalization()(c5)
    c5 = Activation('relu')(c5)
    c5 = Dropout(0.1)(c5)
    ...
    c6 = Conv2D(128, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(u6)
    c6 = BatchNormalization()(c6)
    c6 = Activation('relu')(c6)
    c6 = Dropout(0.1)(c6)
    c6 = Conv2D(128, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c6)
    c6 = BatchNormalization()(c6)
    c6 = Activation('relu')(c6)
    c6 = Dropout(0.1)(c6)
    ...
    c7 = Conv2D(64, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(u7)
    c7 = BatchNormalization()(c7)
    c7 = Activation('relu')(c7)
    c7 = Dropout(0.1)(c7)
    c7 = Conv2D(64, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c7)
    c7 = BatchNormalization()(c7)
    c7 = Activation('relu')(c7)
    c7 = Dropout(0.1)(c7)
    ...
    c8 = Conv2D(32, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(u8)
    c8 = BatchNormalization()(c8)
    c8 = Activation('relu')(c8)
    c8 = Dropout(0.1)(c8)
    c8 = Conv2D(32, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c8)
    c8 = BatchNormalization()(c8)
    c8 = Activation('relu')(c8)
    c8 = Dropout(0.1)(c8)
    ...
    c9 = Conv2D(16, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(u9)
    c9 = BatchNormalization()(c9)
    c9 = Activation('relu')(c9)
    c9 = Dropout(0.1)(c9)
    c9 = Conv2D(16, (3, 3), kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(0.01))(c9)
    c9 = BatchNormalization()(c9)
    c9 = Activation('relu')(c9)
    c9 = Dropout(0.1)(c9)
    ...
    # model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy', dice_coef, MeanIoU(num_classes=2), Precision(), Recall()])
...
# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  checkpoint = ModelCheckpoint(f'best_unet_model_fold{fold_number}.keras', monitor='val_loss', save_best_only=True, verbose=1)
...
results_df.to_excel('123.xlsx', index=False)

# prompt: download excel

from google.colab import files
files.download('123.xlsx')